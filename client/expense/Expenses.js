...
// use a useEffect hook to make a fetch call to the list expenses API 
//in order to retrieve the initial list of expenses. We also initialize the 
//values that are necessary for making 
//this request and for rendering the response to be received from the server,
...
export default function Expenses() {
  ...
  //  invoke the handleSearchFieldChange method to get the selected date value
...
//two DatePicker components to collect the first day
